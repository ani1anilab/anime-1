...
const resp = await axios.get("https://localhost:4444/api/");
...
```bash
  https://localhost:4444/api/info?id={string}
```
...
```javascript
import axios from "axios";
const resp = await axios.get("https://localhost:4444/api/top-ten");
console.log(resp.data);
```
...
const resp = await axios.get(
  "https://localhost:4444/api/info?id=yami-shibai-9-17879"
);
console.log(resp.data);
```
...
```bash
  https://localhost:4444/api/{string}?page={number}
  #or
  https://localhost:4444/api/{string}
```
...
import axios from "axios";
const resp = await axios.get(
  "https://localhost:4444/api/most-popular?page=1"
);
console.log(resp.data);
```
...
```bash
  https://localhost:4444/api/search?keyword={string}
```
...
import axios from "axios";
const resp = await axios.get(
  "https://localhost:4444/api/search?keyword=one%20punch%20man"
);
console.log(resp.data);
```
...
```bash
  https://localhost:4444/api/stream?id={string}
```
...
import axios from "axios";
const resp = await axios.get(
  "https://localhost:4444/api/stream?id=frieren-beyond-journeys-end-18542?ep=107257"
);
console.log(resp.data);
```
